package com.wingedtech.common.security.oauth2.config;
...
public class OAuth2Properties {
     ...
     * 扩展 client
     */
    private List<WebClientConfiguration> webClientConfigurations = new ArrayList<>(12);
    ...
    public List<WebClientConfiguration> getWebClientConfigurations() {
        return webClientConfigurations;
    }
