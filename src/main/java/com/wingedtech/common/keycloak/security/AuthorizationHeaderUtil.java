...
public class AuthorizationHeaderUtil {
    ...
    public Optional<String> getAuthorizationHeader() {
        ...
        // 网关服务下可获得用户身份的OAuth2AuthenticationToken
        if (authentication instanceof OAuth2AuthenticationToken) {
            ...
            if (accessToken != null) {
                ...
                if (isExpired(accessToken)) {
                    log.debug("[{}] AccessToken expired, refreshing automatically", name);
        ...
        // 各业务服务不会直接获得OAuth2AuthenticationToken, 通常业务服务只能得到JwtAuthenticationToken
