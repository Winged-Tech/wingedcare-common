package com.wingedtech.common.id.generator;

/**
 * Twitter_Snowflake
 * SnowFlake的结构如下(每部分用-分开):
 * 0 - 0000000000 0000000000 0000000000 0000000000 0 - 00000 00000 - 00000 00000 00
...
public class TwitterSnowFlake {
     ...
     * 提供单例工具
     */
     private static TwitterSnowFlake snowFlake = new TwitterSnowFlake(0, 0);
     public static TwitterSnowFlake getInstance(long workerId, long datacenterId){
     ...
     */
    private TwitterSnowFlake(long workerId, long datacenterId) {
...
//        TwitterSnowFlake idWorker = TwitterSnowFlake.getInstance(0, 0);
//        for (int i = 0; i < 50; i++) {
